            ...
            <tr>
                ...
                <td class="amount-area">
                    <div class="amount-break">
                        ...
                        <div class="amount-name">
                            Discount
                            <h2 class="title">{{ $addInvoiceMaster->discounts->rate }} %</h2>
                        </div>
                        <div class="amount-name">
                            Taxes
                            <h2 class="title">{{ $addInvoiceMaster->taxes->tax_rate_in }} %</h2>
                        </div>
                        <div class="amount-name">
                            Shipping Charge
                            <h2 class="title">{{ $addInvoiceMaster->shippingCharge->tax_rate_in }} %</h2>
                        </div>
                    </div>
