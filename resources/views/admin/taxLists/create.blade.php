...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.taxList.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tax-lists.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_rate_in') ? 'is-invalid' : '' }}" type="text" name="tax_rate_in" id="tax_rate_in" value="{{ old('tax_rate_in', '') }}" required>
