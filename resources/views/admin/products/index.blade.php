            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.product.fields.product_thumbnail_image') }}
                        </th>
                        <th>
                        ...
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                @if($product->product_thumbnail_image)
                                    <a href="{{ $product->product_thumbnail_image->getUrl() }}" target="_blank" style="display: inline-block">
                                        <img src="{{ $product->product_thumbnail_image->getUrl('thumb') }}">
                                    </a>
                                @endif
                            </td>
                            <td>
