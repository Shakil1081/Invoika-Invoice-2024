...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.companyList.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.company-lists.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('postalcode') ? 'is-invalid' : '' }}" type="text" name="postalcode" id="postalcode" value="{{ old('postalcode', '') }}" required>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('invoice_number_slug') ? 'is-invalid' : '' }}" type="text" name="invoice_number_slug" id="invoice_number_slug" value="{{ old('invoice_number_slug', '') }}" required>
